...
function HomeContentTitle(props) {
    return (
        <div className={background}>
            <div id="Features" className="container flex max-w-screen-xl mx-auto justify-center items-center  md:min-h-full pt-40 md:px-60">
