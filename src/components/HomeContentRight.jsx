import contentImage from '../assets/home/essenceBodyOil.webp'
...
function HomeContentRight(props) {
    return (
        <div className={background}>
            <div id="Features" className="container flex max-w-screen-xl mx-auto justify-center items-center  font-Signikta md:min-h-full pt-5 pb-5 px-10 md:px-60">
