import contentImage from '../assets/home/essenceElixirCase.webp'
import { Link } from 'react-router-dom';

const background = "bg-backgroundColorPrimary";
const image = contentImage;
const heading = 'NEW';
const subHeading1 = 'THE LIMITED-EDITION\nESSENCE ELIXIR CASE';
const button = 'SHOP NOW';

function HomeContentLeft(props) {
    return (
        <div className={background}>
            <div id="Features" className="container flex max-w-screen-xl mx-auto justify-center items-center  font-Signikta md:min-h-full pt-10 pb-5 px-10 md:px-60">
